...
const
   cQRName = 'QuickReport 5.04.2'; { This string should not be resourced }
   cQRVersion = 50;
...
var
  ...
  begin
    ...
    // DeviceMode is a property of TPrintersettings
...
{$ifdef EXTRA_DEVMODE}
    ...
    // DevMode is a property of TPrintersettings
