...
{$ENDIF}
          try
            ...
            Result := true except on E: Exception
            do
            begin
              Result := false;
            end;
...
{$IFNDEF Win32}
    ...
    try
{$ENDIF}
      if CheckNumber(s1, FloatNumber) or CheckVariable(s1, VariableID)
        or CheckNegate(s1, s2 {$IFNDEF Win32}^{$ENDIF}) or CheckAdd(s1, s2
        {$IFNDEF Win32}^{$ENDIF}, s3 {$IFNDEF Win32}^
        {$ENDIF}) or CheckSubtract(s1, s2 {$IFNDEF Win32}^{$ENDIF}, s3
        {$IFNDEF Win32}^{$ENDIF}) or CheckMultiply(s1, s2 {$IFNDEF Win32}^
        {$ENDIF}, s3 {$IFNDEF Win32}^{$ENDIF}) or CheckIntegerDiv(s1, s2
        {$IFNDEF Win32}^{$ENDIF}, s3 {$IFNDEF Win32}^
        {$ENDIF}) or CheckModulo(s1, s2 {$IFNDEF Win32}^{$ENDIF}, s3
        {$IFNDEF Win32}^{$ENDIF}) or CheckRealDivision(s1, s2
        {$IFNDEF Win32}^{$ENDIF}, s3 {$IFNDEF Win32}^
        {$ENDIF}) or CheckPower(s1, s2 {$IFNDEF Win32}^{$ENDIF}, s3
        {$IFNDEF Win32}^{$ENDIF}, fsort) or CheckFuncTwoVar(s1, s2
        {$IFNDEF Win32}^{$ENDIF}, s3 {$IFNDEF Win32}^
        {$ENDIF}) or CheckFuncOneVar(s1, s2 {$IFNDEF Win32}^{$ENDIF}) then
        Result := true
      else if CheckBracket(s1, s2 {$IFNDEF Win32}^{$ENDIF}) then
      begin
...
{$ENDIF}
        ...
        begin
          ...
          Result := CheckVariable(s1, VariableID) or CheckPower(s1, s2
            {$IFNDEF Win32}^{$ENDIF}, s3 {$IFNDEF Win32}^
            {$ENDIF}, fsort) or CheckFuncOneVar(s1, s2 {$IFNDEF Win32}^
            {$ENDIF}) or CheckFuncTwoVar(s1, s2 {$IFNDEF Win32}^{$ENDIF}, s3
            {$IFNDEF Win32}^{$ENDIF});
{$IFNDEF Win32}
      finally
        dispose(s2);
  ...
  begin
    ...
    repeat
      ...
      begin
        ...
        if Result then
        begin
          Result := CheckVariable(s1, VariableID) or CheckNumber(s1,
            FloatNumber);
{$IFNDEF Win32}
          new(s3);
          new(s4);
...
{$ENDIF}
            ...
            if not Result then
              Result := CheckNegate(s1, s3 {$IFNDEF Win32}^
                {$ENDIF}) or CheckSubtract(s1, s3 {$IFNDEF Win32}^
                {$ENDIF}, s4 {$IFNDEF Win32}^
                {$ENDIF}) or CheckMultiply(s1, s3 {$IFNDEF Win32}^
                {$ENDIF}, s4 {$IFNDEF Win32}^
                {$ENDIF}) or CheckIntegerDiv(s1, s3 {$IFNDEF Win32}^
                {$ENDIF}, s4 {$IFNDEF Win32}^{$ENDIF}) or CheckModulo(s1, s3
                {$IFNDEF Win32}^{$ENDIF}, s4 {$IFNDEF Win32}^
                {$ENDIF}) or CheckRealDivision(s1, s3 {$IFNDEF Win32}^
                {$ENDIF}, s4 {$IFNDEF Win32}^{$ENDIF}) or CheckPower(s1, s3
                {$IFNDEF Win32}^{$ENDIF}, s4 {$IFNDEF Win32}^
                {$ENDIF}, fsort) or CheckFuncOneVar(s1, s3 {$IFNDEF Win32}^
                {$ENDIF}) or CheckFuncTwoVar(s1, s3 {$IFNDEF Win32}^
                {$ENDIF}, s4 {$IFNDEF Win32}^{$ENDIF});

            if Result then
            begin
              Result := CheckVariable(s2, VariableID) or CheckNumber(s2,
                FloatNumber);
              ...
              begin
                ...
                if Result then
                  ...
                  Result := CheckAdd(s2, s3 {$IFNDEF Win32}^{$ENDIF}, s4
                    {$IFNDEF Win32}^{$ENDIF}) or CheckSubtract(s2, s3
                    {$IFNDEF Win32}^{$ENDIF}, s4 {$IFNDEF Win32}^
                    {$ENDIF}) or CheckMultiply(s2, s3 {$IFNDEF Win32}^
                    {$ENDIF}, s4 {$IFNDEF Win32}^
                    {$ENDIF}) or CheckIntegerDiv(s2, s3 {$IFNDEF Win32}^
                    {$ENDIF}, s4 {$IFNDEF Win32}^
                    {$ENDIF}) or CheckModulo(s2, s3 {$IFNDEF Win32}^
                    {$ENDIF}, s4 {$IFNDEF Win32}^
                    {$ENDIF}) or CheckRealDivision(s2, s3
                    {$IFNDEF Win32}^{$ENDIF}, s4 {$IFNDEF Win32}^
                    {$ENDIF}) or CheckPower(s2, s3 {$IFNDEF Win32}^
                    {$ENDIF}, s4 {$IFNDEF Win32}^
                    {$ENDIF}, fsort) or CheckFuncOneVar(s2, s3
                    {$IFNDEF Win32}^{$ENDIF}) or CheckFuncTwoVar(s2, s3
                    {$IFNDEF Win32}^{$ENDIF}, s4 {$IFNDEF Win32}^{$ENDIF});
              end;
            end;
{$IFNDEF Win32}
          finally
            ...
            begin
              ...
              begin
                ...
                if Result then
                  ...
                  Result := CheckMultiply(s2, s3 {$IFNDEF Win32}^{$ENDIF}, s4
                    {$IFNDEF Win32}^{$ENDIF}) or CheckIntegerDiv(s2, s3
                    {$IFNDEF Win32}^{$ENDIF}, s4 {$IFNDEF Win32}^
                    {$ENDIF}) or CheckModulo(s2, s3 {$IFNDEF Win32}^
                    {$ENDIF}, s4 {$IFNDEF Win32}^
                    {$ENDIF}) or CheckRealDivision(s2, s3
              ...
              begin
                ...
                begin
                  ...
                  if Result then
                    ...
                    Result := CheckPower(s2, s3 {$IFNDEF Win32}^{$ENDIF}, s4
                      {$IFNDEF Win32}^
                      {$ENDIF}, fsort) or CheckFuncOneVar(s2, s3
                      {$IFNDEF Win32}^{$ENDIF}) or CheckFuncTwoVar(s2, s3
                      {$IFNDEF Win32}^{$ENDIF}, s4 {$IFNDEF Win32}^{$ENDIF});
...
{$ENDIF}
            ...
            if not Result then
              Result := CheckFuncOneVar(s1, s3 {$IFNDEF Win32}^
                {$ENDIF}) or CheckFuncTwoVar(s1, s3 {$IFNDEF Win32}^
                {$ENDIF}, s4 {$IFNDEF Win32}^{$ENDIF});
            ...
            begin
              ...
              begin
                ...
                if not Result then
                begin
                  Result := CheckFuncOneVar(s2, s3 {$IFNDEF Win32}^
                    {$ENDIF}) or CheckFuncTwoVar(s2, s3 {$IFNDEF Win32}^
                    {$ENDIF}, s4 {$IFNDEF Win32}^{$ENDIF});
                end;
...
var
  ...
  ANewTerm,
  { need this particlar pointer to guarantee a good, flawless memory cleanup in except }
...
begin
  ...
  try { this block protects the whole of ALL assignments... }
    ...
    repeat
          ...
          begin
            ...
            begin
              ...
              if Position[3] = 1 then
                Matrix^[CurrentBracket, i]^.Arg1 := PParserFloat
                  (Variables.Objects[VariableID])
              else
                Matrix^[CurrentBracket, i]^.Arg2 := PParserFloat
                  (Variables.Objects[VariableID])
            end
            else
            begin
                ...
                begin
                  ...
                  begin
                    ...
                    begin
                      ...
                      begin
                        if CheckIntegerDiv(StartString, LeftString,
                          RightString) then
                          Token := IntDiv
                        else
                        begin
            ...
            try
              ...
              begin
                case Token of
                  FuncOneVar:
                    with FunctionOne do
                      Matrix^[CurrentBracket, i] := CreateOperation(Token,
                        Objects[IndexOf(copy(StartString, 1, pos('(',
                              StartString) - 1))]);
                ...
                if Position[3] = 1 then
                  Matrix^[Position[1], Position[2]]^.Arg1 := Matrix^
                    [CurrentBracket, i]^.Dest
                else
                  Matrix^[Position[1], Position[2]]^.Arg2 := Matrix^
                    [CurrentBracket, i]^.Dest;
              ...
              if LastTerm^.Token in [minus, square, third, fourth,
                FuncOneVar] then
      ...
      with FirstTerm^ do
        if (LastTerm = FirstTerm) and ((Token in [minus, square, third, fourth,
            FuncOneVar]) or ((Token in (TokenOperators + [FuncTwoVar]))
              and assigned(Next2))) then
        begin
          break;
        end;
    ...
    begin
      ...
      if assigned(LastTerm) and (LastTerm <> Next2Term) and
        (LastTerm <> Next1Term) then
        dispose(LastTerm);
